...
Namespace ImportDataFromDataView
	Partial Public Class Form1
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRun.Click
            ...
            ' Import the DataView of the DataTable into the worksheet starting at cell position (1, 1)
            sheet.InsertDataView(dataTable.DefaultView, True, 1, 1)

            ' Save the workbook to an Excel file named "ImportDataFromDataView_output.xlsx" in Excel 2013 format
