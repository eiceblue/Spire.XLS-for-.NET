...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRun
			// 
			this.btnRun.Location = new System.Drawing.Point(272, 56);
			...
			// btnAbout
			// 
			this.btnAbout.Location = new System.Drawing.Point(352, 56);
			...
			this.label1.Text = "The sample demonstrates how to align image.";
			// 
			// Form1
			// 
		...
		private void btnRun_Click(object sender, System.EventArgs e)
		{
            ...
            ExcelPicture ep= sheet.Pictures.Add(1,1,@"..\..\..\..\..\..\Data\day.jpg");
            ep.LeftColumnOffset = 200;
            ep.TopRowOffset = 200;
