...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRun
			// 
			this.btnRun.Location = new System.Drawing.Point(448, 48);
			...
			// btnAbout
			// 
			this.btnAbout.Location = new System.Drawing.Point(528, 48);
			...
			this.label1.Text = "The sample demonstrates how to  read an excel workbook from a xml file.";
			// 
			// Form1
			// 
		...
		private void btnRun_Click(object sender, System.EventArgs e)
		{
            ...
            using (FileStream fileStream = File.OpenRead(@"..\..\..\..\..\..\Data\ReadXMLSample.Xml"))
            {
