...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "The sample demonstrates how to Set DataValidation On Separate Sheet.";
			// 
			// Form1
			// 
		...
		private void btnRun_Click(object sender, System.EventArgs e)
		{
            ...
            sheet1.Range["C1"].Text = "Data1";
            sheet1.Range["C2"].Text = "Data2";
            sheet1.Range["C3"].Text = "Data3";
            //The property is to enable the data can be from different sheet.
            sheet1.ParentWorkbook.Allow3DRangesInDataValidation = true;
            workbook.Worksheets[0].Range["A1"].DataValidation.DataRange = workbook.Worksheets[1].Range["C1:C3"];
