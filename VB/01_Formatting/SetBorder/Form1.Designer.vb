Namespace SetBorder
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' btnRun
			' 
			Me.btnRun.Location = New Point(404, 59)
...
'			Me.btnRun.Click += New System.EventHandler(Me.btnRun_Click)
			...
			' btnClose
			' 
			Me.btnClose.Location = New Point(484, 59)
...
'			Me.btnClose.Click += New System.EventHandler(Me.btnClose_Click)
			...
			Me.label1.Size = New Size(460, 14)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to set border to cell in an excel workbook."
			' 
			' Form1
			' 
			Me.AutoScaleBaseSize = New Size(6, 14)
			Me.ClientSize = New Size(573, 94)
