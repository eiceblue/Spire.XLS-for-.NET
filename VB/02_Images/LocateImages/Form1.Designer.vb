Namespace LocateImages
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' btnRun
			' 
			Me.btnRun.Location = New Point(289, 58)
...
'			Me.btnRun.Click += New System.EventHandler(Me.btnRun_Click)
			...
			' btnClose
			' 
			Me.btnClose.Location = New Point(369, 58)
...
'			Me.btnClose.Click += New System.EventHandler(Me.btnClose_Click)
			...
			Me.label1.Size = New Size(430, 14)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to insert images at specified position."
			' 
			' Form1
			' 
